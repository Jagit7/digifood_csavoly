...
@section('titre')
Digifood - dolgozói fiók aktiválása
@endsection
            ...
            <div class="df-auth-form-wrapper">
                ...
                <div class="login-form">
                    ...
                    <div class="login-head">
                        ...
                        <p>Adja meg a dolgozói e-mail címét a dolgozói fiók aktiválásához.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('employee.activation.send') }}">
                        @csrf
                    ...
                    <div class="text-center">
                        <a href="{{ route('employee.login') }}" class="btn-link text-primary">Vissza a belépéshez</a>
                    </div>
