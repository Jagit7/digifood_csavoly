            ...
            <div class="df-auth-form-wrapper">
                ...
                <div class="login-form">
                    ...
                    <div class="login-head">
                        ...
                        <p>Aktiválja a Digifood dolgozói hozzáférést az új jelszó megadásával.</p>
                    </div>

                    <h6 class="login-title"><span>Dolgozói fiók aktiválása</span></h6>
                    ...
                    <div class="alert alert-light border mb-4">
                        <div><strong>Dolgozó:</strong> {{ $display_name }}</div>
                    ...
                    <form method="POST" action="{{ route('employee.activation.store', ['token' => $token]) }}">
                        @csrf
