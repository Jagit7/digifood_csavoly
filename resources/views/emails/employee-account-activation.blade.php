...
<head>
    ...
    <title>Digifood - Dolgozói fiók aktiválása</title>
</head>
                ...
                <tr>
                    <td align="center" style="padding:22px 35px 0 35px;">
                        <div style="margin:0;font-size:13px;line-height:20px;font-weight:600;letter-spacing:0.4px;color:#8a93a3;text-transform:uppercase;">
                            Dolgozói hozzáférés aktiválása
                        </div>
                ...
                <tr>
                    <td style="padding:30px 42px 38px 42px;font-size:15px;line-height:1.7;color:#3d4451;">
                        ...
                        <p style="margin:0 0 16px 0;">
                            Az intézménynél rögzített dolgozói e-mail címéhez Digifood dolgozói hozzáférés tartozik.
                        </p>

                        <p style="margin:0 0 24px 0;">
                            A fiók aktiválásához és saját jelszava beállításához kattintson az alábbi gombra.
                        </p>
                        ...
                        <div style="margin:0 0 20px 0;padding:18px 20px;border-radius:12px;background-color:#f8fafc;border:1px solid #e2e8f0;color:#475569;">
                            ...
                            <div style="font-size:14px;line-height:22px;">
                                Az aktiváló link {{ $expiresInMinutes }} percig érvényes.
                            </div>

                            <div style="font-size:14px;line-height:22px;">
                                Ha nem Ön kezdeményezte az aktiválást, kérjük, hagyja figyelmen kívül ezt az üzenetet.
                            </div>
                        </div>

                        @if (($institutionNames ?? collect())->count() > 1)
                            <p style="margin:0 0 14px 0;font-size:14px;color:#64748b;">
                                A hozzáférés több kapcsolt intézményi dolgozói rekordhoz is tartozhat.
                            </p>
                        @endif
