...
<head>
    ...
    <title>Digifood - Szülői fiók aktiválása</title>
</head>
                ...
                <tr>
                    <td style="padding:30px 42px 38px 42px;font-size:15px;line-height:1.7;color:#3d4451;">
                        ...
                        <p style="margin:0 0 16px 0;">
                            Az intézménynél rögzített gondviselői e-mail címéhez Digifood szülői hozzáférés tartozik.
                        </p>
                        ...
                        @if (($institutionNames ?? collect())->count() > 1)
                            <p style="margin:0 0 14px 0;font-size:14px;color:#64748b;">
                                A hozzáférés több kapcsolt intézményi gondviselői rekordhoz is tartozhat.
                            </p>
                        @endif
