...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        @include('layouts.partials.components.ui.stats-card', [
            ...
            'value' => number_format(\App\Support\Finance\SettlementAmountPresenter::payableDisplayAmount((int) $stats['total_payable']), 0, ',', ' ') . ' Ft',
            'subtitle' => \App\Support\Finance\SettlementAmountPresenter::hasOverpayment((int) $stats['total_payable'])
                ? 'Fennmaradó túlfizetés összesen: ' . number_format(\App\Support\Finance\SettlementAmountPresenter::overpaymentAmount((int) $stats['total_payable']), 0, ',', ' ') . ' Ft'
                : 'Havi előírás összesen',
            'icon' => 'fa-solid fa-wallet',
