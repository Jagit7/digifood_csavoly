...
<head>
    <meta charset="UTF-8">
    <title>Vonalkódos kártya - {{ $institution->name }}</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 10mm;
...
<body>
    <div class="page-shell">
        <div class="toolbar">
            <div class="toolbar-title">{{ $institution->name }} · dolgozói vonalkártya</div>
            <div class="toolbar-actions">
                <a href="{{ route('dashboard.institution.employees.edit', $employee) }}">Vissza</a>
        ...
        <section class="card-wrap">
            <article class="barcode-card">
                ...
                <div class="barcode-card-name">{{ $employee->name }}</div>
                <div class="barcode-card-role">Dolgozó</div>
                <div class="barcode-svg">{!! $barcodeSvg !!}</div>
                <div class="barcode-token">{{ $employee->barcode_token }}</div>
