...
class ParentLegalPageController extends Controller
{
    ...
    public function termsOfService(Request $request): View
    {
        return $this->renderPage(
            ...
            subtitle: 'A Digifood szülői felület használatának általános feltételei',
    ...
    private function renderPage(Request $request, string $title, string $subtitle, string $contentView): View
    {
        return $this->renderLegalPage(
            request: $request,
            pageView: 'parent.legal.page',
            routePrefix: 'parent.legal',
            fallbackRouteName: 'parent.dashboard',
            title: $title,
            subtitle: $subtitle,
