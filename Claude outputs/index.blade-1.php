...
@include('layouts.partials.components.ui.stats-card', [
        'title' => 'Fizetendő összesen',
        'value' => number_format($summary['total_payable_display'] ?? max(0, $summary['total_payable']), 0, ',', ' ') . ' Ft',
        'subtitle' => ($summary['overpayment_total'] ?? 0) > 0
            ? ('Fennmaradó túlfizetés: ' . number_format($summary['overpayment_total'], 0, ',', ' ') . ' Ft')
            : ($summary['children_count'] . ' gyermek elszámolása'),
    ...
    @if($summary['has_split_statements'] ?? false)
        @include('layouts.partials.components.ui.stats-card', [
            'title' => 'Zsárica rész',
                        ...
                        <div class="card-body p-4">
                            ...
                            @else
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <div class="rounded-4 bg-light h-100 p-3">
                                            <div class="df-settlement-label mb-2">{{ $card['previous_balance_label'] }}</div>
                                            <div class="df-settlement-value">{{ number_format($card['previous_balance_display'], 0, ',', ' ') }} Ft</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xl-3">
                                        <div class="rounded-4 bg-light h-100 p-3">
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <div class="rounded-4 bg-light h-100 p-3">
                                            <div class="df-settlement-label mb-2">Aktuális havi fizetendő</div>
                                            <div class="df-settlement-value">{{ number_format($card['invoiceable_amount'], 0, ',', ' ') }} Ft</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xl-3">
                                        <div class="rounded-4 bg-light h-100 p-3">
                                            <div class="df-settlement-label mb-2">Fizetendő összesen</div>
                                            <div class="df-settlement-value">{{ number_format($card['current_total_display'], 0, ',', ' ') }} Ft</div>
                                        </div>
                                    </div>
                                    @if(($card['overpayment_amount'] ?? 0) > 0)
                                        <div class="col-md-6 col-xl-3">
                                            <div class="rounded-4 bg-light h-100 p-3">
                                                <div class="df-settlement-label mb-2">Fennmaradó túlfizetés</div>
                                                <div class="df-settlement-value text-success">{{ number_format($card['overpayment_amount'], 0, ',', ' ') }} Ft</div>
                                            </div>
                                        </div>
                                    @endif
                                </div>
