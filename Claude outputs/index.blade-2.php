                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="df-payment-kpi">
                                        ...
                                        <div class="df-payment-value">{{ number_format($focus_summary['total_payable_display'] ?? max(0, $focus_summary['total_payable']), 0, ',', ' ') }} Ft</div>
                                        @if(($focus_summary['overpayment_total'] ?? 0) > 0)
                                            <div class="small text-success mt-1">Fennmaradó túlfizetés: {{ number_format($focus_summary['overpayment_total'], 0, ',', ' ') }} Ft</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-6">
